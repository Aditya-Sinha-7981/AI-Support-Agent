    ...
    >
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          className="w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-slate-900 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 dark:border-[#2b2d31] dark:bg-[#383a40] dark:text-[#dbdee1] dark:placeholder:text-[#949ba4] dark:focus:border-[#5865f2] dark:focus:ring-[#5865f2]/30"
        />
        <button
          type="submit"
          className="rounded-xl bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-500 hover:shadow-lg active:scale-95 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:shadow-none dark:bg-[#5865f2] dark:hover:bg-[#4752c4]"
